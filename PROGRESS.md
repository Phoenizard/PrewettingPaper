...
- doc/analysis/figures/ 下 angle1_omega_phasemap.png 与 angle1_omega_metrics.csv 建在作废的
  phi2_inf_max 指标上，当前已无任何文件引用，待换指标重跑时替换或删除。
...
- doc/analysis/angle1_omega.md 清空重写，仅保留研究设定（Topic + 控制变量 + 观测变量），
  不含任何结论。doc/analysis/figures/ 下旧图与旧 CSV 暂留，待换指标重跑时替换。
